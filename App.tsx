...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-3 sm:p-6 md:p-8 flex flex-col items-center transition-colors duration-300 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      <header className="w-full max-w-7xl mb-6 md:mb-10 flex flex-col md:flex-row md:justify-between md:items-end gap-6">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-3">
            ...
            <button 
              onClick={toggleTheme}
              className="p-2 rounded-full bg-slate-200 dark:bg-slate-800 hover:ring-2 ring-teal-500 transition-all focus:outline-none"
          ...
          <div className="flex items-center gap-2 mt-1">
            <div className={`w-2 h-2 rounded-full ${saveStatus === 'saving' ? 'bg-amber-500 animate-pulse' : saveStatus === 'saved' ? 'bg-green-500' : 'bg-slate-300'}`}></div>
